...
- **완벽한 우회 로직:** - `curl_cffi`를 활용하여 최신 Chrome 브라우저로 위장, Cloudflare의 봇 방어막과 CAPTCHA를 스무스하게 통과합니다.
...
VPN(예: Gluetun)을 적용하여 안전하게 구동하는 것을 권장합니다.

```yaml
version: '3'
services:
  missav-dlp-web:
    image: nerdnam/missav-dlp-web:0.0.1
